...
- (NSDictionary*)resultDict {
    ...
    if (num_cols > 0) {
        ...
        while ((columnName = [columnNames nextObject])) {
            ...
            NSRange range = [columnName rangeOfString:@"_hichat"];
            NSString *columnNameWithoutSuffix = [columnName substringToIndex:range.location];
            [dict setObject:objectValue forKey:columnNameWithoutSuffix];
        }
