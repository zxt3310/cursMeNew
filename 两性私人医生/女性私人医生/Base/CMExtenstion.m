...
+ (NSData*)gzipData:(NSData*)pUncompressedData
{
    ...
    } while ( deflateStatus == Z_OK && zlibStreamStruct.avail_in != 0 && zlibStreamStruct.avail_out != 0 );
    ...
    NSLog(@"%s: Compressed file from %lu KB to %lu KB", __func__, (unsigned long)([pUncompressedData length]/1024), (unsigned long)([compressedData length]/1024));
