//
//  UINewBubbleTableViewMapInfoCell.m
//  CureMe
//
...
@implementation UINewBubbleTableViewMapInfoCell
...
- (void)mainThreadRefresh
{
    ...
    [_bubbleViewController reloadData:[[NSNumber alloc] initWithInt:NSCROLLNONE]];
}
