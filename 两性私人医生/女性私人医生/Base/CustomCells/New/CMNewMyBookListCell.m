...
@implementation NewBookCellTitleView
...
- (void)initializatoin
{
    ...
    background.frame = CGRectMake(0, 3, 320, NBOOKLISTCELL_TITLEHEIGHT - 3);
...
@implementation NewBookCellInfoView
...
- (void)initialization
{
    ...
    background = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 320, NBOOKLISTCELL_INFOHEIGHT - 1)];
    [background setBackgroundColor:[UIColor clearColor]];
    [self addSubview:background];
...
- (void)setHasDoctorReply:(bool)hasDoctorReply
{
    ...
    if (_hasDoctorReply) {
        ...
        background.frame = CGRectMake(0, 0, 320, NBOOKLISTCELL_INFOHEIGHT);
    }
    else {
        background.image = [CMImageUtils defaultImageUtil].qaCellAnswerTailImage;
        background.frame = CGRectMake(0, 0, 320, NBOOKLISTCELL_INFOHEIGHT - 3);
    }
}
...
@implementation NewBookCellReplyView
...
- (void)initialization
{
    ...
    background.frame = CGRectMake(0, 0, 320, NBOOKLISTCELL_REPLYHEIGHT - 3);
    [background setBackgroundColor:[UIColor clearColor]];
    [self addSubview:background];
...
#pragma mark CMNewMyBookListCell
@implementation CMNewMyBookListCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _bookCellType = NMYBOOKCELL_TYPE_LIST;
        
        // Initialization code
        _titleSubView = [[NewBookCellTitleView alloc] initWithFrame:CGRectMake(0, 0, 320, NBOOKLISTCELL_TITLEHEIGHT)];
        [self.contentView addSubview:_titleSubView];
        
        _infoSubView = [[NewBookCellInfoView alloc] initWithFrame:CGRectMake(0, NBOOKLISTCELL_TITLEHEIGHT, 320, NBOOKLISTCELL_INFOHEIGHT)];
        [self.contentView addSubview:_infoSubView];
        
        _replySubView = [[NewBookCellReplyView alloc] initWithFrame:CGRectMake(0, NBOOKLISTCELL_TITLEHEIGHT + NBOOKLISTCELL_INFOHEIGHT, 320, NBOOKLISTCELL_REPLYHEIGHT)];
