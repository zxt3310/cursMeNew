...
- (id)init {
    ...
    if (self) {
        ...
        if ([[UIDevice currentDevice] systemVersion].floatValue >= 6.0) {
            backgroundImage = [backgroundImage imageWithAlignmentRectInsets:UIEdgeInsetsMake(30, 0, 0, 0)];
        }
        else {
            backgroundImage = [backgroundImage stretchableImageWithLeftCapWidth:0.0 topCapHeight:30.0];
        }
